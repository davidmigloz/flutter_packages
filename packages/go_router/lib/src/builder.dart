...
class _CustomNavigatorState extends State<_CustomNavigator> {
  ...
  static NoTransitionPage<T>? _tryWrapNoTransitionPage<T>(NoTransitionPage<Object?> page) {
...
class _OffstageSelectionDisabler extends StatefulWidget {
  ...
  @override
  State<_OffstageSelectionDisabler> createState() => _OffstageSelectionDisablerState();
}

class _OffstageSelectionDisablerState extends State<_OffstageSelectionDisabler> {
  final GlobalKey _childKey = GlobalKey(debugLabel: '_OffstageSelectionDisabler');
