  ...
  group('RouteBuilder', () {
    ...
    group('Shell navigator semantics boundary', () {
      testWidgets('Chrome painted before a ShellRoute Navigator stays in the '
          'semantics tree alongside routed content', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets(
        'ShellRoute Navigator is wrapped in a Semantics(container: true) '
        'boundary',
        (WidgetTester tester) async {
          final shellNavigatorKey = GlobalKey<NavigatorState>();
          final router = GoRouter(
          ...
          final Iterable<Semantics> ancestorSemantics = tester
              .widgetList<Semantics>(
                find.ancestor(
                  of: find.byKey(shellNavigatorKey),
      ...
      testWidgets(
        'Root GoRouter Navigator is not wrapped in an extra Semantics '
        'container boundary',
        (WidgetTester tester) async {
          final rootNavigatorKey = GlobalKey<NavigatorState>();
          final router = GoRouter(
