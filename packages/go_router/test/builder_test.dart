...
void main() {
  group('RouteBuilder', () {
    ...
    group('Offstage selection guard', () {
      testWidgets('Offstage pages disable selection to prevent dead zones '
          'when SelectionArea wraps ShellRoute child (builder)', (WidgetTester tester) async {
                  ...
                  routes: <RouteBase>[
                    GoRoute(
                      ...
                      builder: (BuildContext context, GoRouterState state) {
                        return Builder(
                          builder: (BuildContext context) {
                            detailPageRegistrar = SelectionContainer.maybeOf(context);
        ...
        expect(listPageRegistrar, isNull, reason: 'Offstage page should have selection disabled');
      });

      testWidgets('Offstage pages disable selection to prevent dead zones '
          'when SelectionArea wraps ShellRoute child (pageBuilder)', (WidgetTester tester) async {
        SelectionRegistrar? listPageRegistrar;
        SelectionRegistrar? detailPageRegistrar;
      ...
      testWidgets('Selection is re-enabled when navigating back to an offstage page', (
        WidgetTester tester,
      ) async {
        SelectionRegistrar? listPageRegistrar;
      ...
      testWidgets('Deep-linked child route has selection disabled on parent from first frame', (
        WidgetTester tester,
      ) async {
        SelectionRegistrar? listPageRegistrar;
        SelectionRegistrar? detailPageRegistrar;
        ...
        expect(
          listPageRegistrar,
          isNull,
          reason: 'Deep-linked parent page should have selection disabled from first frame',
        );
        expect(
          detailPageRegistrar,
          isNotNull,
      ...
      testWidgets('3+ level nesting disables selection on all offstage ancestors', (
        WidgetTester tester,
      ) async {
                  ...
                  routes: <RouteBase>[
                    GoRoute(
                      ...
                      builder: (BuildContext context, GoRouterState state) {
                        return Builder(
                          builder: (BuildContext context) {
                            pageBRegistrar = SelectionContainer.maybeOf(context);
                      ...
                      routes: <RouteBase>[
                        GoRoute(
                          ...
                          builder: (BuildContext context, GoRouterState state) {
                            return Builder(
                              builder: (BuildContext context) {
                                pageCRegistrar = SelectionContainer.maybeOf(context);
        ...
        expect(pageCRegistrar, isNotNull, reason: 'Current page should have selection enabled');
      });

      testWidgets('Offstage selection disabled with CustomTransitionPage pageBuilder', (
        WidgetTester tester,
      ) async {
        SelectionRegistrar? listPageRegistrar;
        SelectionRegistrar? detailPageRegistrar;
        ...
        expect(
          listPageRegistrar,
          isNull,
          reason: 'Offstage page (CustomTransitionPage) should have selection disabled',
        );
      });

      testWidgets('Selection re-enables after pop navigation', (WidgetTester tester) async {
        SelectionRegistrar? listPageRegistrar;
        ...
        router.pop();
        await tester.pumpAndSettle();
        expect(listPageRegistrar, isNotNull, reason: 'Selection should re-enable after pop');
      });
      ...
      testWidgets('Deep-linked page re-enables selection after navigating back', (
        ...
        expect(
          listPageRegistrar,
          isNotNull,
          reason: 'Selection should be re-enabled on page that was always offstage until now',
        );
      });
      ...
      testWidgets('StatefulShellRoute disables selection on inactive branches', (
                  ...
                  routes: <RouteBase>[
                    GoRoute(
                      ...
                      builder: (BuildContext context, GoRouterState state) => Builder(
                        builder: (BuildContext context) {
                          branchARegistrar = SelectionContainer.maybeOf(context);
                ...
                StatefulShellBranch(
                  routes: <RouteBase>[
                    GoRoute(
                      ...
                      builder: (BuildContext context, GoRouterState state) => Builder(
                        builder: (BuildContext context) {
                          branchBRegistrar = SelectionContainer.maybeOf(context);
        ...
        expect(branchBRegistrar, isNotNull, reason: 'Active branch should have selection enabled');
        expect(branchARegistrar, isNull, reason: 'Inactive branch should have selection disabled');
      ...
      testWidgets('StatefulShellRoute preserves navigator state with selection guard', (
        WidgetTester tester,
      ) async {
        final router = GoRouter(
          initialLocation: '/a',
      ...
      testWidgets('StatefulShellRoute selection composes with route-level '
                ...
                StatefulShellBranch(
                  routes: <RouteBase>[
                    GoRoute(
                      ...
                      builder: (BuildContext context, GoRouterState state) => Builder(
                        builder: (BuildContext context) {
                          branchARootRegistrar = SelectionContainer.maybeOf(context);
                      ...
                      routes: <RouteBase>[
                        GoRoute(
                          ...
                          builder: (BuildContext context, GoRouterState state) => Builder(
                            builder: (BuildContext context) {
                              branchADetailRegistrar = SelectionContainer.maybeOf(context);
        ...
        expect(
          ...
          isNull,
          reason: 'Offstage route within active branch should have selection disabled',
        );
        ...
        expect(
          branchADetailRegistrar,
          isNotNull,
          reason: 'Current route should have selection re-enabled after branch switch',
        );
        expect(
          branchARootRegistrar,
          isNull,
          reason: 'Route-level offstage disabling should still work after branch switch',
        );
      });

      testWidgets('ShellRoute preserves widget State when navigating to child and back', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('StatefulShellRoute preserves widget State in branch during tab switching', (
        WidgetTester tester,
      ) async {
        final controller = TextEditingController();
        addTearDown(controller.dispose);
        ...
        expect(
          controller.text,
          'preserved text',
          reason: 'Widget State should survive branch switching with selection guard',
        );
      });
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            listPageRegistrar,
            isNull,
            reason: 'Offstage page (NoTransitionPage<dynamic>) should have selection disabled',
          );
        },
      );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            listPageRegistrar,
            isNull,
            reason: 'Offstage page (CustomTransitionPage<dynamic>) should have selection disabled',
          );
        },
      );
    });
